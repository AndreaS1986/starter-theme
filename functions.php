...
if ( ! function_exists( 'starter_theme_setup' ) ) :
    function starter_theme_setup() {
        ...
        //The second parameter is the width, and the third is the height. The final parameter is whether the image should be hard cropped to that size vs resized but not cropped. You can omit it entirely to have it not crop the images
